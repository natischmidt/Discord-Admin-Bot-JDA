...
public class CommandHandler extends ListenerAdapter {
    ...
    static {
        colorMap.put("red", 0xFF0000); colorMap.put("blue", 0x0000FF); colorMap.put("black", 0x000000); colorMap.put("white", 0xFFFFFF); colorMap.put("yellow", 0xFFFF00);colorMap.put("orange", 0xFFA500);colorMap.put("green", 0x00FF00);colorMap.put("purple", 0x800080);colorMap.put("pink", 0xFFC0CB);colorMap.put("brown", 0xA52A2A);colorMap.put("gray", 0x808080);colorMap.put("cyan", 0x00FFFF);colorMap.put("magenta", 0xFF00FF);colorMap.put("violet", 0xEE82EE);colorMap.put("indigo", 0x4B0082);colorMap.put("gold", 0xFFD700);colorMap.put("silver", 0xC0C0C0);colorMap.put("olive", 0x808000);colorMap.put("teal", 0x008080);colorMap.put("navy", 0x000080);colorMap.put("coral", 0xFF7F50);colorMap.put("lime", 0x00FF00);colorMap.put("lavender", 0xE6E6FA);colorMap.put("peach", 0xFFDAB9);colorMap.put("salmon", 0xFA8072);colorMap.put("skyblue", 0x87CEEB);
    }
